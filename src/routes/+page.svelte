	...
	<IntersectionObserver once element={node} let:intersecting>
		...
		<div class="min-h-screen bg-amber-50 py-12 sm:py-16 md:py-20">
			<div class="mx-auto max-w-6xl space-y-16 px-4 sm:space-y-24 sm:px-6 md:space-y-32 lg:px-8">
				...
				<div
					bind:this={node}
					class="share-projects flex min-h-[444.38px] flex-col items-center gap-6 md:flex-row md:gap-8 lg:gap-12"
				>
					{#if intersecting}
						<div transition:fade={{ delay: 300 }} class="share-project md:w-1/2 lg:w-2/5">
							<img
								src="projects.png"
								alt="Share Projects"
						...
						<div
							...
							class="w-full text-center md:w-1/2 md:text-left lg:w-3/5"
						>
							...
							<p class="text-base font-medium leading-relaxed text-gray-700 sm:text-lg">
								Showcase your latest creations and discoveries with the community! Share your
								projects for others to see, get feedback, collaborate and be inspired.
							</p>
						</div>
					{/if}
				</div>
				...
				<div
					bind:this={node}
					class="seek-advice flex flex-col items-center gap-6 md:flex-row-reverse md:gap-8 lg:gap-12"
				>
					{#if intersecting}
						<div transition:fade={{ delay: 500 }} class="w-full md:w-1/2 lg:w-2/5">
							<enhanced:img
				...
				<!-- Item Grow Together -->
				<div class="grow-together flex flex-col items-center gap-6 md:flex-row md:gap-8 lg:gap-12">
					{#if intersecting}
						<div transition:fade={{ delay: 1500 }} class="w-full md:w-1/2 lg:w-2/5">
							<video
						...
						>
							...
							<p class="text-base font-medium leading-relaxed text-gray-700 sm:text-lg">
								Join quarterly event meetups to collaboration and get invaluable insights into
								various industries. Network with peers, share experiences, and learn from experts to
								expand your knowledge base, discover new opportunities, and collectively advance
