...
<div class="min-h-screen bg-amber-50 pb-8">
	<div class="mx-32">
		...
		<div class="max-w-2x mx-auto p-6 md:p-8">
			<SparklesText/>
		</div>
		...
		<div class="flex items-center">
			<img
				...
				alt="Interior view of a church altar with a cross"
				class="rounded-lg shadow-md w-[560px] h-[700px] object-cover"				
			/>
			<p class="text-center leading-relaxed text-gray-700 font-bold">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione eum asperiores consectetur quam! Tenetur repellendus nostrum molestiae in corporis, tempora debitis perferendis tempore fugiat itaque hic porro consequuntur ea adipisci?
			</p>
